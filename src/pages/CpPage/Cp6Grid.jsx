...
return (
    ...
    <div className="OllGrid">
                            ...
                            {console.log("Error?",oll,PermTable[j],getSameOppInfo(oll,PermTable[j],0,cubeSize).path)}
                            
                           {console.log("Error?2",oll,PermTable[j],getSameOppInfo(oll,PermTable[j],0,cubeSize).path)}
                        {/* {console.log("Error?2",oll,PermTable[j],getSameOppInfo(oll,PermTable[j],0,cubeSize).path)} */}
                                                <CpRecOverlay
                                                    cubeSize={cubeSize}
                                                    arrowsInfo={[
